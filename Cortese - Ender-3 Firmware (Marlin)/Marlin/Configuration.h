...
#define STRING_CONFIG_H_AUTHOR "(LCortese, Ender-3)" // Who made the changes.
...
#define PREHEAT_1_FAN_SPEED   0 // Value from 0 to 255 according to the original Ender 3 firmware

#define PREHEAT_2_TEMP_HOTEND 240
#define PREHEAT_2_TEMP_BED    75
#define PREHEAT_2_FAN_SPEED   0 // Value from 0 to 255 according to the original Ender 3 firmware
